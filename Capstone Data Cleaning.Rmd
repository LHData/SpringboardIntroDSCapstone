...
```
Create some data sets: one with stop percentage by ethnicity for each division for all years. The second will be the same thing, just for 2010 (the year the census data is from). For each data set, add data with the ethnicity data by division populations for the neighborhood.  
```{r}
...
#stops_summary_all_years$ethnicity_count = NULL

stops_summary_2010 <- filter(stops_summary_by_year, year == 2010)
...
stops_summary_all_years_with_pop <- bind_rows(stops_summary_all_years, division_pop)
stops_summary_2010_with_pop <- bind_rows(stops_summary_2010, division_pop)

write_csv(stops_summary_2010_with_pop, path = "C:/Users/lahebert.REDMOND/Documents/Learning/Springboard/Introduction to Data Science/Capstone/Data/Output/stops_summary_2010.csv")
